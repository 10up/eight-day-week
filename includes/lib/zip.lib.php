<?php
/**
 * Handles creating the zipped files
 *
...
class ZipFile {
	 ...
	 * @return void
	 */
	public function setdo_write() {
		$this->do_write = true;
	} // end of the 'setdo_write()' method
	 ...
	 * @access private
	 */
	public function unix_2_dos_time( $unixtime = 0 ) {
		...
		return ( ( $timearray['year'] - 1980 ) << 25 )
			...
			| ( $timearray['minutes'] << 5 )
			| ( $timearray['seconds'] >> 1 );
	} // end of the 'unix_2_dos_time()' method
